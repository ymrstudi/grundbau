...
\newpage
\pagestyle{empty}
\includepdf[pages=1,pagecommand={},scale=1]{gabione1.pdf}

\includepdf[pages=1,pagecommand={},scale=1, landscape]{gabione2.pdf}
...
\newpage
\pagestyle{empty}
\includepdf[pages=1,pagecommand={},scale=1]{Traegerbohlwand1.pdf}
\includepdf[pages=1,pagecommand={},scale=1, landscape]{Traegerbohlwand2.pdf}
\includepdf[pages=1,pagecommand={},scale=1]{Traegerbohlwand3.pdf}
\pagestyle{plain}
...
\newpage
\pagestyle{empty}
\includepdf[pages=1,pagecommand={},scale=1]{Halle1.pdf}

\includepdf[pages=1,pagecommand={},scale=1]{Halle2.pdf}
\includepdf[pages=1,pagecommand={},scale=1]{Halle3.pdf}
\pagestyle{plain}
\newpage
